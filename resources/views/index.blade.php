                ...
                <div class="py-6 px-5 lg:flex">
                    ...
                    <div class="flex-1 flex flex-col justify-between">
                        <header class="mt-8 lg:mt-0">
                            ...
                            <div class="mt-4">
                                <h1 class="text-3xl">
                                    This is a big title and it will look great
                                    on two or even three lines. Wooohoo!
                                </h1>
                        ...
                        <footer class="flex justify-between items-center mt-8">
                            ...
                            <div class="hidden lg:block">
                                <a href="/posts" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 hover:bg-gray-300 rounded-full py-2 px-8">Read More</a>
                            </div>
                        </footer>
                    </div>
                </div>
                    ...
                    <div class="py-6 px-5">
                        ...
                        <div class="mt-8 flex flex-col justify-between">
                            <header>
                                ...
                                <div class="mt-4">
                                    <h1 class="text-3xl">
                                        This is a big title and it will look
                                        great on two or even three lines.
                                        Wooohoo!
                                    </h1>
                        ...
                        <div class="py-6 px-5">
                            ...
                            <div class="mt-8 flex flex-col justify-between">
                                ...
                                <footer class="flex justify-between items-center mt-8">
                                    ...
                                    <div>
                                        <a href="<?php echo $item->slug; ?>" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 hover:bg-gray-300 rounded-full py-2 px-8">
                                            Read More
                                        </a>
                                    </div>
                                </footer>
